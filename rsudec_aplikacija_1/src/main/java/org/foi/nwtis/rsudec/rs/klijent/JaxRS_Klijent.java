 ...
 */
package org.foi.nwtis.rsudec.rs.klijent;
 ...
 * USAGE:
 * <pre>
 *        JaxRS_Klijent client = new JaxRS_Klijent();
...
private String korisnik;
    ...
    public JaxRS_Klijent() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("rest");
    }
    public JaxRS_Klijent(String korisnik, String lozinka) {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("rest");
    ...
    public Response prijemKomande(Object requestEntity, String komanda, String vrijeme) throws ClientErrorException {
        return webTarget.path("komande").request(javax.ws.rs.core.MediaType.APPLICATION_JSON)
                .header("korisnik", korisnik)
                .header("lozinka", lozinka)
                .header("komanda", komanda)
                .header("vrijeme", vrijeme)
    ...
    public Response obrisiLetoveAerodromaKorisnika(String icao) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("{0}/avioni", new Object[]{icao})).request().delete(Response.class);
    }
    ...
    public Response obrisiAerodromKorisnika(String icao) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{icao})).request().delete(Response.class);
    }
